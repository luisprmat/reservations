    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                @else
                    <div class="h-16 justify-between space-x-8 sm:flex sm:-my-px sm:ml-10">
        ...
        <div class="pb-1 border-t border-gray-200 dark:border-gray-600">
            @auth
                ...
                <div class="mt-3 space-y-1">
                    ...
                    @if(auth()->user()->role_id === \App\Enums\Role::GUIDE->value)
                        <x-responsive-nav-link :href="route('guide-activity.show')">
                            {{ __('My Activities') }}
                        </x-responsive-nav-link>
                    @else
                        <x-responsive-nav-link :href="route('my-activity.show')">
                            {{ __('My Activities') }}
                        </x-responsive-nav-link>
                    @endif
